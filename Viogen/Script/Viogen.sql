...
CREATE TABLE USUARIAS (
    ...
    CONSTRAINT CK_DNI CHECK(substring(DNI, 1, 7) REGEXP '[0-9]' AND SUBSTRING(DNI, 9, 1) REGEXP '[A-Z]'),
...
-- INSERT INTO RIESGO VALUES ('A', 'Alto');
-- INSERT INTO USUARIAS VALUES (DEFAULT, '12345678E', '', '', '', '','','', 'A');
