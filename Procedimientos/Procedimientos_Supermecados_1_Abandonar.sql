DELIMITER //
DROP PROCEDURE IF EXISTS OBTENER_PRECIOS_1//
CREATE PROCEDURE OBTENER_PRECIOS_1( IN P_ID_PRODUCTO INT,
                                  OUT P_PRECIO FLOAT,
                                  OUT P_ABANDONAR INT)
OP:BEGIN
   SELECT  PRECIO     		
...
DELIMITER //
DROP PROCEDURE IF EXISTS VENTA_NUEVA_1//
CREATE PROCEDURE VENTA_NUEVA_1( IN P_ID_PRODUCTO INT,
								 P_CANTIDAD INT,
                                 P_PRECIO FLOAT,
...
DELIMITER //
DROP PROCEDURE IF EXISTS OBTENER_ULTIMA_VENTA_1//
CREATE PROCEDURE OBTENER_ULTIMA_VENTA_1( OUT P_ID_ULTIMA_VENTA INT )
BEGIN
  SELECT ID_VENTA
		FROM VENTA
...
-- -----------------------------------------------------------------------------------
DELIMITER //
DROP PROCEDURE IF EXISTS OBTENER_ID_EMPLEADO_1//
CREATE PROCEDURE OBTENER_ID_EMPLEADO_1(  OUT P_ID_EMPLEADO INT,
									   OUT P_ABANDONAR INT)
OP:BEGIN
...
DELIMITER //
DROP PROCEDURE IF EXISTS OBTENER_ID_TIENDA_1//
CREATE PROCEDURE OBTENER_ID_TIENDA_1(IN P_ID_EMPLEADO INT,
                                   OUT P_ID_TIENDA INT,
                                   OUT P_ABANDONAR INT)
OP:BEGIN
 	 SELECT ID_TIENDA
...
DELIMITER //
DROP PROCEDURE IF EXISTS ACTUALIZAR_STOCK_1//
CREATE PROCEDURE ACTUALIZAR_STOCK_1(IN P_CANTIDAD INT,
...
DELIMITER //
DROP PROCEDURE IF EXISTS MOSTRAR_DATOS_VENTA_1//
CREATE PROCEDURE MOSTRAR_DATOS_VENTA_1(IN P_ID_ULTIMA_VENTA INT)
    BEGIN
        SELECT *
        FROM PRODUCTO 
